    ...
    <div className="page-top pb-36 md:pb-48">
      <div className="max-w-4xl mx-auto container-pad text-center">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="body-lg text-stone mb-20 max-w-2xl mx-auto">{donateContent.subtitle}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-20">
          {donateContent.impact.map((item, i) => (
            <motion.button
              ...
              className="bg-white rounded-3xl p-12 md:p-16 border border-linen/50 hover:border-forest hover:shadow-lg transition-all text-left group"
            >
        ...
        <motion.div
          ...
          className="bg-moss text-cream rounded-3xl p-12 md:p-16"
        >
