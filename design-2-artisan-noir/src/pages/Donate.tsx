    ...
    <div className="page-shell page-end">
      <div className="max-w-2xl mx-auto container-pad text-center">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="body-lg text-mist/45 mb-16">{donateContent.subtitle}</p>
        </motion.div>
        ...
        <div className="space-y-10 text-left">
          {donateContent.impact.map((item, i) => (
            <motion.button
              ...
              className="w-full border border-gold/25 card-pad hover:border-gold transition-colors text-left group"
            >
              <p className="text-3xl md:text-4xl font-semibold tracking-tight text-gold mb-4 group-hover:scale-[1.02] transition-transform inline-block">
                {item.amount}
              </p>
        ...
        <motion.div
          ...
          className="border border-gold/30 card-pad mt-10 mb-32"
        >
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-6">Make a Custom Donation</h2>
          <p className="body-lg text-mist/55 mb-10">Every contribution helps us reach more children and create sustainable livelihoods.</p>
