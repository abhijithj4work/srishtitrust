    ...
    >
      <TiltCard intensity={10}>
        <Link
          ...
          className="group block relative overflow-hidden rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.14)] transition-shadow duration-500"
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 text-cream">
            <h3 className="text-xl md:text-2xl font-semibold tracking-tight mb-2 group-hover:text-terracotta transition-colors">
              {institute.name}
            </h3>
