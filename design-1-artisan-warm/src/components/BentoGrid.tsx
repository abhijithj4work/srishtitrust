...
export default function BentoGrid() {
  ...
  return (
    <div className="bg-cream">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid md:grid-cols-12 gap-6 md:gap-8">
            <Reveal className="md:col-span-7">
              <div className="h-full min-h-[280px] p-10 md:p-12 border border-charcoal/6 bg-cream/50 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] hover:shadow-[0_16px_48px_rgba(0,0,0,0.1)] transition-shadow duration-500">
                <span className="text-[11px] font-medium text-terracotta tracking-widest">01</span>
                <h3 className="text-xl md:text-2xl font-semibold tracking-tight mt-4 mb-4">{pillars[0].title}</h3>
                <p className="text-warm-gray text-sm md:text-base leading-[1.8] max-w-lg">{pillars[0].description}</p>
              </div>
            </Reveal>
            <div className="md:col-span-5 flex flex-col gap-6 md:gap-8">
              {pillars.slice(1).map((pillar, i) => (
                <Reveal key={pillar.title} delay={(i + 1) * 0.08}>
                  <div className="p-8 md:p-10 border border-charcoal/6 bg-cream/50 rounded-2xl flex-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] transition-shadow duration-500">
                    <span className="text-[11px] font-medium text-terracotta tracking-widest">0{i + 2}</span>
      ...
      <section className="py-24 md:py-32 bg-charcoal text-cream grain-overlay">
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-12 lg:gap-16">
          <Reveal>
            <motion.div whileHover={{ rotateX: 2, scale: 1.01 }} style={{ transformPerspective: 1200 }} className="p-10 md:p-12 border border-charcoal/6 rounded-2xl bg-white/60 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.06)] hover:shadow-[0_16px_48px_rgba(0,0,0,0.1)] transition-shadow duration-500 h-full">
          ...
          <Reveal delay={0.1}>
            <motion.div whileHover={{ rotateX: 2, scale: 1.01 }} style={{ transformPerspective: 1200 }} className="p-10 md:p-12 bg-olive text-cream rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.15)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.2)] transition-shadow duration-500 h-full">
