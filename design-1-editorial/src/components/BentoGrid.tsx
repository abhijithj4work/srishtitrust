...
function SectionHeader({ label, title, description }: { label: string; title: string; description?: string }) {
  return (
    <div className="mb-12 md:mb-16 max-w-2xl">
      ...
      <h2 className="text-2xl md:text-4xl font-bold tracking-tight text-charcoal leading-tight">{title}</h2>
...
export default function BentoGrid() {
  ...
  return (
    <div className="bg-cream">
      <section className="py-24 md:py-32 border-t border-linen">
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {makingADifference.pillars.map((pillar, i) => (
              <Reveal key={pillar.title} delay={i * 0.08}>
                <div className="p-8 md:p-10 border border-linen rounded-2xl bg-cream/50 shadow-[0_8px_32px_rgba(0,0,0,0.04)] hover:shadow-[0_16px_48px_rgba(0,0,0,0.08)] transition-shadow duration-500">
                  <span className="text-[11px] font-bold text-forest tracking-widest">0{i + 1}</span>
          ...
          <blockquote className="mt-16 md:mt-20 pt-12 border-t border-linen max-w-3xl mx-auto text-center">
            ...
            <cite className="text-[11px] uppercase tracking-[0.15em] text-stone mt-6 block not-italic">
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-12 lg:gap-16">
          <Reveal>
            <motion.div whileHover={{ rotateX: 2, scale: 1.01 }} style={{ transformPerspective: 1200 }} className="p-10 md:p-12 border border-linen rounded-2xl bg-white/60 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.06)] hover:shadow-[0_16px_48px_rgba(0,0,0,0.1)] transition-shadow duration-500 h-full">
          ...
          <Reveal delay={0.1}>
            <motion.div whileHover={{ rotateX: 2, scale: 1.01 }} style={{ transformPerspective: 1200 }} className="p-10 md:p-12 bg-forest text-cream rounded-2xl shadow-[0_12px_40px_rgba(47,79,62,0.25)] hover:shadow-[0_20px_50px_rgba(47,79,62,0.35)] transition-shadow duration-500 h-full">
      ...
      <section className="py-20 md:py-24 bg-linen/40 border-t border-linen">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <Reveal>
            <p className="text-[11px] uppercase tracking-[0.2em] text-stone mb-4">Support us</p>
            <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4">Help us reach more lives</h2>
