        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-20 max-w-3xl">
          {pillars.map((pillar, i) => (
            <Reveal key={pillar.title} delay={0.3 + i * 0.1}>
              <div className="bg-charcoal/40 backdrop-blur-xl border border-cream/10 p-6 rounded-xl hover:border-cream/25 transition-colors duration-500">
                <span className="text-forest text-[10px] font-bold tracking-[0.2em]">0{i + 1}</span>
